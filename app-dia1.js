(() => {
  ...
  function d9CrownRoadCard(){const scenes=[
    ["d9-corona-vertical-00-bo-grip-v1.png","Mi fortaleza llevará mi nombre.","1379–1404 · Bo Jonsson Grip construye Gripsholm. Tras su muerte, sus herederos la venden a Margarita: entra en la Corona.","Bo Jonsson Grip, sus herederos y la fortaleza medieval de Gripsholm",false,0],
    ["d9-corona-vertical-01-olaf-v1.png","Mi hijo ha muerto. La Corona necesita continuidad.","1387 · Muere Olaf, único hijo de Margarita. La Corona necesita un heredero.","Margarita I ante la noticia de la muerte de su hijo Olaf, con Tre Kronor al fondo",false,1],
    ["d9-corona-vertical-02-erik-v1.png","¿Una corona para tres reinos?","1397 · Erik es coronado rey de Dinamarca, Noruega y Suecia.","Erik de Pomerania es coronado ante los símbolos de Dinamarca, Noruega y Suecia",true,2],
    ["d9-corona-vertical-03-rivalidades-v1.png","Compartir corona no elimina rivalidades.","La Unión de Kalmar dura, pero Suecia discute quién debe gobernarla.","Nobles suecos discuten el poder durante la Unión de Kalmar",false,3],
    ["d9-corona-vertical-04-sture-v1.png","Suecia no quiere gobernarse desde lejos.","1520 · Sten Sture el Joven muere tras la batalla de Bogesund.","Sten Sture el Joven, herido tras la batalla de Bogesund, con sus partidarios",true,4],
    ["d9-corona-vertical-05-cristian-v1.png","Prometieron amnistía. Las puertas se cierran.","1520 · Cristián II promete amnistía; el Día 1 cuenta lo que ocurrió después.","Cristián II llega a caballo y promete amnistía",false,5],
    ["d9-corona-vertical-06-gustavo-v1.png","Suecia elegirá a su propio rey.","1523 · Gustavo Vasa es elegido rey de Suecia.","Gustavo Vasa es aclamado rey de Suecia en 1523",true,6]
  ...
  function d9PaxCard(){const scenes=[
    ["d9-pax-vertical-01-corona-v1.png","Esta fortaleza pasa a ser propiedad de la Corona.","1404 · Margarita incorpora Gripsholm a la Corona.","Margarita I incorpora la fortaleza medieval de Gripsholm a las tierras de la Corona"],
    ["d9-pax-vertical-02-intercambio-v1.png","No es un regalo: cambio tierras heredadas por Näsby y Gripsholm.","1472 · Sten entrega Ekebyhof y otros bienes; recibe Näsby, la finca donde está Gripsholm.","Sten Sture el Viejo negocia un intercambio de tierras por Näsby y Gripsholm"],
    ["d9-pax-vertical-03-monasterio-v1.png","Queremos una cartuja: estudio, oración y silencio.","1493 · Los obispos impulsan el monasterio y Sten Sture aporta Gripsholm. De Pax Mariæ nace Mariefred.","Los obispos y Sten Sture planean el monasterio cartujo Pax Mariæ junto al lago Mälaren"],
    ["d9-pax-vertical-04-recupera-v1.png","La Corona reclama la herencia de los Sture.","1526 · Gustavo Vasa disuelve Pax Mariæ y toma Gripsholm. Es el cambio concreto de propiedad.","Gustavo Vasa y sus escribanos inventarían los bienes del monasterio tras la Reforma"],
    ["d9-pax-vertical-05-castillo-v1.png","Aquí habrá una residencia fortificada.","1537 · Gustavo Vasa derriba gran parte del antiguo monasterio y comienza el castillo de ladrillo que habéis visitado.","Gustavo Vasa supervisa la construcción del actual castillo de ladrillo de Gripsholm"]
