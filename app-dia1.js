(() => {
  ...
  function d9CrownRoadCard(){return d9Card("UNA CORONA · MÁS DE 125 AÑOS DE TENSIÓN",`<figure class="d9-story-art d9-comic-strip"><img src="${imgBase}d9-tira-corona-comic-v1.png" alt="Tira histórica en cómic desde Margarita I hasta Gustav Vasa, con bocadillos y cartelas de fechas"><figcaption>Diálogos recreados para contar la historia; las cartelas fijan las fechas y los hechos.</figcaption></figure>`,"La Unión de Kalmar compartía una corona; no eliminó las disputas por quién debía gobernar Suecia.")}
  function d9SturesCard(){return d9Card("DOS STEN STURE · NO SON EL MISMO",`<div class="d9-sture-compare"><div><b>STEN STURE EL VIEJO</b><span>gran noble y regente</span><strong>Gripsholm · 1472</strong><small>Obtiene la finca; muere en 1503.</small></div><div><b>STEN STURE EL JOVEN</b><span>gran noble y regente</span><strong>Bogesund · 1520</strong><small>Herido en la batalla; conecta con la amnistía y el Baño de Sangre del Día 1.</small></div></div>`,"Mismo apellido y oficio político; una generación de distancia y dos historias distintas.")}
  function d9PaxCard(){return d9Card("UNA LLAVE · CINCO MANOS",`<figure class="d9-story-art d9-comic-strip"><img src="${imgBase}d9-tira-llaves-comic-v1.png" alt="Tira histórica en cómic de los cambios de propiedad de Gripsholm, con bocadillos y cartelas de fechas"><figcaption>Diálogos recreados para contar la historia; las cartelas fijan los cambios de propiedad.</figcaption></figure><div class="d9-word-chain"><span><b>PAX MARIÆ</b><small>latín · Paz de María</small></span><i>→</i><span><b>MARIAS FRED</b><small>sueco · Paz de María</small></span><i>→</i><span><b>MARIEFRED</b><small>nombre de la ciudad</small></span></div>`,"No es «la propiedad de un obispo»: fue un monasterio cartujo cuyos bienes pasaron al Estado durante la Reforma.")}
  ...
  function d9CastlesCard(){return d9Card("SEIS LUGARES · SEIS PROBLEMAS DE PODER",`<div class="d9-sweden-map"><svg viewBox="0 0 320 450" role="img" aria-label="Mapa esquemático de Suecia meridional y central con seis puntos históricos"><path d="M166 20c30 13 44 42 34 69l8 34-17 31 13 35-21 35 6 41-22 42 5 44-26 28 5 48-33 26-32-18-12-44 14-37-10-42 18-37-3-44 19-28-5-42 24-30-3-34 30-28z" fill="#dce9e6" stroke="#1678a7" stroke-width="3"/><path d="M50 346c34-23 58-20 75 2l-10 54-50-5z" fill="#dce9e6" stroke="#1678a7" stroke-width="3"/><path d="M50 384c42 13 73 16 111-1" fill="none" stroke="#8fb9c8" stroke-width="5"/><g class="d9-map-dot"><circle cx="166" cy="85" r="13"/><text x="166" y="90">1</text><circle cx="131" cy="190" r="13"/><text x="131" y="195">2</text><circle cx="102" cy="212" r="13"/><text x="102" y="217">3</text><circle cx="84" cy="246" r="13"/><text x="84" y="251">4</text><circle cx="61" cy="367" r="13"/><text x="61" y="372">5</text><circle cx="99" cy="227" r="13"/><text x="99" y="232">6</text></g><text x="202" y="85" class="d9-map-label">KALMAR</text><text x="154" y="185" class="d9-map-label">ESTOCOLMO</text><text x="31" y="209" class="d9-map-label">ÖREBRO</text><text x="12" y="263" class="d9-map-label">KARLSBORG</text><text x="76" y="409" class="d9-map-label">GOTEMBURGO</text><text x="116" y="246" class="d9-map-label">GRIPSHOLM</text></svg></div><div class="d9-place-list"><div><b>1 · KALMAR</b><span>Unión de tres reinos · 56.66, 16.36</span></div><div><b>2 · ESTOCOLMO</b><span>corona y crisis política · 59.33, 18.07</span></div><div><b>3 · ÖREBRO</b><span>cruce, comercio y rebelión · 59.27, 15.21</span></div><div><b>4 · KARLSBORG</b><span>capital de reserva · 58.54, 14.51</span></div><div><b>5 · SKANSEN KRONAN</b><span>defensa de Gotemburgo · 57.70, 11.95</span></div><div><b>6 · GRIPSHOLM</b><span>residencia, prisión y memoria · 59.26, 17.22</span></div></div>`,"No son seis castillos iguales: son seis lugares que contestan a preguntas distintas sobre poder, rutas y defensa.")}
  ...
  function d9FamilyCard(){return d9Card("FAMILIA VASA · CORONAS Y CANDADOS",`<div class="d9-family-tree"><div class="d9-person root"><b>GUSTAV VASA</b><span>👑 rey desde 1523</span></div><div class="d9-branch"><div class="d9-person"><b>ERIK XIV</b><span>👑 hijo mayor</span><small>1563–67 · encierra a Johan y Katarina</small></div><div class="d9-person"><b>JOHAN III</b><span>🔒 primero prisionero</span><small>1568 · toma el poder</small></div></div><div class="d9-branch outcome"><div class="d9-person"><b>KARIN MÅNSDOTTER<br>Y SUS HIJOS</b><span>🔒 presos con Erik en 1571</span></div><div class="d9-person"><b>KATARINA JAGELLONICA</b><span>🔒 presa con Johan</span><small>dos hijos nacen en Gripsholm</small></div></div></div>`,"👑 = tuvo la corona · 🔒 = estuvo preso o presa en Gripsholm. El árbol explica parentesco; las fechas explican quién tenía las llaves.")}
