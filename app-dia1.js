Warning: truncated output (original token count: 43288)
...
(() => {
  ...
  function d3RevoltMap(){return d3MapCard("1434–1435 · LA PROTESTA SE EXTIENDE",annotatedMap([14.3,17.4,59.0,60.7],[["Bergslagen",15.3,60.1,-46,-12],["Borganäs",15.3,60.3,10,-12],["Västerås",16.…3288 tokens truncated…es desde Vättern</span></div></div></div>`}
