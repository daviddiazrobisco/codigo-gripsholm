(() => {
  ...
  function bindD4ParkRoutes(){
    const tracks=[
      ...
      {id:"vitsand",n:"Vitsand",ll:[58.72877,14.56925],img:"vitsand-playa-2026.jpg",credit:"Foto aportada para este cuaderno, 2026",copy:"Playa de arena clara y orilla de entrada suave. Está junto al inicio de la ruta de Junker; si el tiempo acompaña, es un buen lugar para parar o bañarse con prudencia."},
      {id:"junker",n:"Junker Jägares sten",ll:[58.7300,14.5764],img:"junker-jagare-stone-public-domain.jpg",credit:"Imagen de apoyo del cuaderno",copy:"La roca está a poca distancia de Vitsand por la ruta blanca: alrededor de 600–900 metros según el punto exacto de inicio y parada."},
      {id:"stigman",n:"Stigmanspasset",ll:[58.7160,14.5920],img:"stigmanspasset-2026.jpg",credit:"Imagen aportada para este cuaderno",copy:"La ruta verde atraviesa un paso entre paredes de roca. El relato de salteadores es una leyenda, no una prueba de un asalto."},
      {id:"trollkyrka",n:"Trollkyrka",ll:[58.7200,14.6098],img:"trolls-tiveden-recreacion-v1.png",credit:"Ilustración narrativa del cuaderno",copy:"Son cumbres rocosas usadas como referencias del paisaje. El nombre pertenece a las leyendas, no demuestra un templo de trolls."},
      {id:"stenkallan",n:"Stenkällan",ll:[58.7203,14.5846],img:"stenkallan-tiveden-silverkey.jpg",credit:"Foto: Silverkey (Mickaël Delcey) · CC BY-SA 4.0 · Wikimedia Commons",copy:"Bloques, grietas y cavidades del granito: una parada para conectar la excursión con la historia del hielo del Día 4."}
    ];
  ...
  function bindD3OrebroExplorer(){
    const places=[
      ...
      {n:"Engelbrekt · Stortorget",ll:[59.272135,15.211772],img:"engelbrekt-statue-orebro.jpg",credit:"Foto: Einarspetz · CC BY-SA 3.0 · Wikimedia Commons",copy:"Estatua posterior de Engelbrekt Engelbrektsson en Stortorget, junto a la iglesia de San Nicolás. Sirve para recordar la figura histórica; no es un retrato de su aspecto real."},
