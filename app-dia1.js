(() => {
  ...
  function d5LakesCard(){return d5Card("CUATRO GRANDES LAGOS",`${annotatedMap([12.2,19,57.85,60.05],[["Vänern",13.2,58.9,-35,-8],["Vättern",14.5,58.4,10,17],["Hjälmaren",15.9,59.25,10,-9],["Mälaren",17.3,59.35,10,18]],[],"Mapa de los cuatro grandes lagos suecos")}<div class="lake-label-list"><div><strong>Vänern</strong><span>El mayor lago de Suecia.</span></div><div><strong>Vättern</strong><span>El gran lago del día.</span></div><div><strong>Mälaren</strong><span>Entrada histórica hacia Estocolmo y Gripsholm.</span></div><div><strong>Hjälmaren</strong><span>El lago próximo a Örebro.</span></div></div>`,"Primero mira el mapa y después abre la prueba: las etiquetas completas ayudan a fijar cada lago.")}
  ...
  function d5GotaMap(){return d5Card("SISTEMA GÖTA · COSTA A COSTA",`${annotatedMap([12.5,19,57.85,59.25],[["Sjötorp",13.98,58.84,-28,-13],["Vänern",13.2,58.92,-29,-10],["Vättern",14.72,58.52,10,18],["Motala",15.04,58.54,10,-10],["Mem",16.4,58.48,9,18],["Báltico",18.2,58.48,10,-9]],[[13.98,58.84,14.72,58.52,"canal + lago",""],[14.72,58.52,15.04,58.54,"","danger"],[15.04,58.54,16.4,58.48,"ríos + canal",""],[16.4,58.48,18.2,58.48,"hacia el mar",""]],"Mapa simplificado del sistema Göta")}<div class="gota-key"><span><b>AGUA NATURAL</b> Vänern, Vättern y ríos.</span><span><b>OBRA HUMANA</b> Canal y esclusas.</span></div>`,"La ruta no es una zanja continua: 190 km de canal se unen a lagos, ríos y otras vías navegables.")}
  function d5LockCard(){return d5Card("CÓMO FUNCIONA UNA ESCLUSA",`<div class="lock-diagram" role="img" aria-label="Esquema de una esclusa: se cierran las compuertas, sube o baja el agua, y se abre la compuerta del otro lado"><div><b>1</b><span>BARCO ENTRA</span></div><i>▮</i><div><b>2</b><span>COMPUERTAS CERRADAS<br>el agua sube o baja</span></div><i>▮</i><div><b>3</b><span>SE ABRE EL OTRO LADO</span></div></div>`,"Una esclusa permite pasar de un nivel de agua a otro. Por eso el canal puede enlazar lagos y tramos con distinta altura.")}
  ...
  function d5CultureCard(){return d5Card("ESTRID ERICSON · DE HJO AL DISEÑO SUECO",`<div class="estrid-timeline"><div><strong>1894 · ÖREGRUND</strong><span>Nace en Öregrund y crece en Hjo, junto a Vättern y el hotel de su familia.</span></div><div><strong>1915–1918 · ESTOCOLMO</strong><span>Se forma como profesora de dibujo en Tekniska skolan, hoy Konstfack.</span></div><div><strong>1924 · SVENSKT TENN</strong><span>Funda en Estocolmo la firma con el artesano del peltre Nils Fougstedt.</span></div><div><strong>1934 · JOSEF FRANK</strong><span>Su colaboración une empresa, muebles, textiles y una forma más cálida de entender el hogar.</span></div></div><p class="source-note"><strong>Precisión:</strong> no he encontrado una relación directa documentada entre Estrid Ericson y Coco Chanel; por eso no la presentamos como un vínculo histórico.</p>`,"Hjo no es una anécdota: su infancia, el hotel familiar y la ciudad junto a Vättern forman parte del comienzo de su historia.")}
