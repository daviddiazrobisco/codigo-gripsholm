(() => {
  ...
  function d4GeologyCard(){return d4Card("ROCA ANTIGUA → HIELO RECIENTE",`<div class="geology-motion" role="img" aria-label="Animación que muestra roca fracturada, hielo en movimiento y bloques que quedan al retirarse el hielo"><div class="geology-sky"><span class="geo-age">~1.000 millones de años</span><i class="geo-rock">ROCA FRACTURADA</i><b class="geo-ice">HIELO</b><em class="geo-boulder">BLOQUE</em><span class="geo-today">hace ~10.000 años · el hielo se retira</span></div><div class="geo-steps"><span><b>1</b> La roca se fractura.</span><span><b>2</b> El hielo aprovecha grietas y mueve bloques.</span><span><b>3</b> Al retirarse, deja bloques y cavidades.</span></div></div>`,"La animación se repite despacio; si el móvil reduce movimiento, queda como un esquema fijo.")}
