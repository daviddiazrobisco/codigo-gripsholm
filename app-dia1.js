(() => {
  ...
  function d6TeaWorldMap(){return d6Card("RUTA COMPLETA · GOTEMBURGO ⇄ CANTÓN",`<div class="world-route-map" role="img" aria-label="Mapa esquemático de la ruta de Gotemburgo a Cantón: mar del Norte, Atlántico, cabo de Buena Esperanza, océano Índico y mar de China Meridional"><div><b>GOTEMBURGO</b><span>mar del Norte</span></div><i>→</i><div><b>ATLÁNTICO</b><span>costa occidental de África</span></div><i>→</i><div><b>CABO DE BUENA ESPERANZA</b><span>giro hacia el Índico</span></div><i>→</i><div><b>OCÉANO ÍNDICO</b><span>vientos y escalas</span></div><i>→</i><div><b>CANTÓN</b><span>mar de China Meridional</span></div></div>`,"Mapa de ruta mundial, simplificado y no a escala: los viajes reales dependían de vientos, escalas y navegación.")}
