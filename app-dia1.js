(() => {
  ...
  function d7PeatCard(){return d7Card("CÓMO NACE UNA TURBERA",`<section class="peat-mobile-sequence" aria-label="Tres pasos para formar una turbera"><article class="peat-step ice"><b>1</b><div><strong>EL HIELO SE RETIRA</strong><span>Queda una depresión con agua de deshielo.</span></div></article><i aria-hidden="true">↓</i><article class="peat-step lake"><b>2</b><div><strong>EL LAGO SE LLENA</strong><span>Plantas de orilla y restos vegetales ocupan poco a poco el agua.</span></div></article><i aria-hidden="true">↓</i><article class="peat-step bog"><b>3</b><div><strong>HUMEDAL → TURBA</strong><span>El agua frena la descomposición: las capas vegetales se acumulan.</span></div></article><p>Un lago no desaparece de golpe: cambia muy despacio durante miles de años.</p></section>`,"La foto de Komosse muestra el paisaje actual; este esquema vertical explica los miles de años que hay debajo de los musgos.")}
  function d7PeatLayersCard(){return d7Card("POR QUÉ LAS PLANTAS SE QUEDAN",`<section class="peat-mobile-layers" aria-label="Corte vertical de las capas de una turbera"><p class="peat-layer live"><b>PLANTAS VIVAS</b><span>musgos y otras plantas en la superficie</span></p><p class="peat-layer recent"><b>RESTOS RECIENTES</b><span>vegetación que empieza a quedar cubierta de agua</span></p><p class="peat-layer peat"><b>TURBA · VEGETACIÓN ANTIGUA</b><span>capas acumuladas durante miles de años</span></p><p class="peat-layer water"><b>POCO OXÍGENO</b><span>el agua limita a los organismos que descomponen los restos</span></p><aside><strong>Suelo corriente:</strong> hay más aire y los restos se descomponen antes. <strong>Turbera:</strong> el agua frena ese proceso y la vegetación se conserva por capas.</aside></section>`,"La turba es vegetación antigua que todavía no ha terminado de convertirse en suelo.")}
  function d7PeatTypesCard(){return d7Card("TRES FORMAS DE TURBERA",`<section class="peat-mobile-types" aria-label="Comparación vertical de tres tipos de turbera"><article class="peat-type low"><div class="peat-rain">💧 💧</div><strong>TURBERA BAJA</strong><span>Agua de lluvia <b>+ agua del terreno</b></span><i>La turba ocupa una zona baja.</i></article><article class="peat-type raised"><div class="peat-rain">💧 💧</div><strong>TURBERA ELEVADA</strong><span>Principalmente <b>agua de lluvia</b></span><i>La turba crece hacia arriba y forma un domo.</i><em>KOMOSSE · ZONAS ELEVADAS</em></article><article class="peat-type blanket"><div class="peat-rain">💧 💧</div><strong>TURBERA DE COBERTURA</strong><span>La turba cubre el relieve.</span><i>Puede extenderse por lomas y depresiones.</i></article></section>`,"Lo que cambia es de dónde llega el agua y qué forma toma la turba. Elevada no significa montaña.")}
  function d7PeatTimelineCard(){return d7Card("KOMOSSE · DIEZ MIL AÑOS DE CAMBIOS",`<ol class="peat-mobile-timeline" aria-label="Cronología vertical de Komosse"><li class="ice"><b>HACE ~10.000 AÑOS</b><span>El hielo se retira.</span></li><li class="lake"><b>HACE ~8.000 AÑOS</b><span>Lago → humedal.</span></li><li class="dry"><b>HACE 6.000–5.000 AÑOS</b><span>Una etapa más cálida y seca frena el crecimiento.</span></li><li class="wet"><b>DESPUÉS</b><span>Vuelve un clima más húmedo: la turbera crece otra vez.</span></li><li class="depth"><b>HOY · KOMOSSE</b><span>La turba suele medir 3–4 m; en algunos puntos supera los 8 m.</span></li></ol>`,"El crecimiento no fue una línea recta: hubo etapas más cálidas y secas y, después, un clima más húmedo que permitió volver a acumular turba.")}
