(() => {
  ...
  function d7PeatCard(){return d7Card("CÓMO NACE UNA TURBERA",`<figure class="visual-evidence peat-figure"><img src="${imgBase}komosse-01-lago-a-turbera.jpg" alt="Secuencia desde el retiro del hielo hasta un humedal con turba"><figcaption>Un lago no desaparece de golpe: se va llenando de plantas y restos vegetales hasta transformarse en humedal.</figcaption></figure>`,"La foto de Komosse muestra el paisaje actual; el esquema explica los miles de años que hay debajo de los musgos.")}
  function d7PeatLayersCard(){return d7Card("POR QUÉ LAS PLANTAS SE QUEDAN",`<figure class="visual-evidence peat-figure"><img src="${imgBase}komosse-02-capaz-de-turba.jpg" alt="Corte de una turbera con plantas vivas, restos vegetales y turba"><figcaption>En un suelo corriente hay aire y los restos se descomponen pronto. En la turbera, el agua deja poco oxígeno y parte de la vegetación queda acumulada.</figcaption></figure>`,"La turba es vegetación antigua que todavía no ha terminado de convertirse en suelo.")}
  function d7PeatTypesCard(){return d7Card("TRES FORMAS DE TURBERA",`<figure class="visual-evidence peat-figure"><img src="${imgBase}komosse-03-tipos-de-turbera.jpg" alt="Comparación de turbera baja, turbera elevada y turbera de cobertura"><figcaption>Komosse es una turbera elevada: su centro ha crecido y recibe principalmente agua de lluvia.</figcaption></figure>`,"Lo que cambia es de dónde llega el agua y qué forma toma la turba. Elevada no significa montaña.")}
  function d7PeatTimelineCard(){return d7Card("KOMOSSE · DIEZ MIL AÑOS DE CAMBIOS",`<figure class="visual-evidence peat-figure"><img src="${imgBase}komosse-04-cronologia.jpg" alt="Cronología de diez mil años de Komosse desde el hielo hasta la turbera elevada"><figcaption>El crecimiento no fue una línea recta: hubo etapas más cálidas y secas y, después, un clima más húmedo que permitió volver a acumular turba.</figcaption></figure>`,"La capa de turba suele medir 3–4 metros en Komosse y, en algunos puntos, supera los 8 metros.")}
  ...
  function d8ImageCard(k,file,alt,caption,note){return d8Card(k,`<figure class="visual-evidence peat-figure"><img src="${imgBase}${file}" alt="${alt}" loading="lazy"><figcaption>${caption}</figcaption></figure>`,note)}
  function d8CompareRaisedCard(){return d8ImageCard("KOMOSSE Y STORE MOSSE", "d8-komosse-store-dos-turberas.png", "Dos cortes de turberas elevadas, Komosse y Store Mosse, alimentadas principalmente por lluvia", "Las dos tienen zonas de turbera elevada: la turba se acumula y crece hacia arriba.", "Komosse no es una única turbera uniforme, pero sus zonas elevadas permiten entender muy bien este mecanismo.")}
  function d8CompareScaleCard(){return d8ImageCard("PARECIDAS, PERO NO IGUALES", "d8-komosse-store-comparacion.png", "Comparación visual entre Komosse y Store Mosse", "Komosse ayuda a entender las capas; Store Mosse muestra lo que ocurre cuando el proceso ocupa un paisaje enorme.", "La comparación sirve para transferir la idea, no para convertir dos paisajes distintos en el mismo lugar.")}
  function d8CompareWaterCard(){return d8ImageCard("EL AGUA DECIDE", "d8-komosse-tipos-agua.png", "Comparación entre turbera elevada, turbera baja y bosque húmedo según el origen del agua", "Un humedal no se define solo porque esté mojado: importa de dónde llega su agua.", "La lluvia, el agua del terreno y el relieve cambian las plantas y la forma de la turba.")}
  function d8RocknarCard(){return d8ImageCard("ROCKNAR · ARENA, PINOS Y TURBA", "d8-rocknar-cronologia.png", "Secuencia desde el hielo y el lago de deshielo hasta las dunas boscosas y la turba de Store Mosse", "Hielo, lago, arena, viento, pinos y turba: el paisaje actual reúne tiempos distintos.", "Los rocknar son dunas de arena cubiertas de bosque, no rocas ni torres.")}
  ...
  function d8PaxCard(){
    const scenes=[
      ["d8-pax-01-fundacion.png","1493: Jakob Ulvsson, Kort Rogge y Sten Sture hacen posible la fundación de Pax Mariæ."],
      ["d8-pax-02-paz-maria.png","Pax Mariæ significa Paz de María; era el único monasterio cartujo de Escandinavia."],
      ["d8-pax-03-gustav.png","1523: Gustav Vasa llega al poder y busca reforzar los recursos de la Corona."],
      ["d8-pax-04-reforma.png","1526–1527: la Reforma transforma las relaciones entre la Corona y la Iglesia."],
      ["d8-pax-05-castillo.png","1537: el monasterio se desmantela; su piedra se reutiliza en la obra de Gripsholm."],
      ["d8-pax-06-mariefred.png","1605: la localidad recibe privilegios y conserva el nombre de Mariefred."]
    ];
    return d8Card("PAX MARIÆ → MARIEFRED",`<section class="d8-comic" aria-label="Seis viñetas sobre el monasterio Pax Mariæ y Mariefred">${scenes.map(([file,alt],i)=>`<figure><img src="${imgBase}${file}" alt="${alt}" ${i?"loading=\"lazy\"":""}><figcaption>VIÑETA ${i+1} DE 6</figcaption></figure>`).join("")}</section>`,"Suecia no dejó de ser cristiana: durante el siglo XVI pasó de un reino católico a uno luterano, mientras la Corona ganó control sobre bienes e ingresos de la Iglesia.")}
  ...
  if("serviceWorker" in navigator&&location.protocol!=="file:")navigator.serviceWorker.register("service-worker.js?v=8-12").catch(()=>{});
  render();
