(() => {
  ...
  function d5GotaExploreMap(q,scope){const opened=prog(scope).opened||[];const stops=[["1","Mem","Báltico"],["2","Canal de Göta","esclusas"],["3","Vättern","gran lago"],["4","Vänern","gran lago"],["5","Göta älv","río + esclusas"],["6","Gotemburgo","Kattegat"]];return d5Card("SISTEMA GÖTA · TOCA LOS NÚMEROS EN ORDEN",`<div class="gota-explore-map"><div class="gota-water"></div><div class="gota-line"></div>${stops.map((s,i)=>`<div class="gota-stop ${opened.includes(i)?"opened":""}" style="--stop:${i}"><b>${s[0]}</b><span>${s[1]}</span><small>${opened.includes(i)?s[2]:""}</small></div>`).join("")}</div><p class="map-caption">Cada número es una etapa. Tócalos en orden debajo del esquema: al abrirlo se ilumina y explica por qué ese lugar conecta la ruta.</p>`)}
  ...
  function d7RouteMap(){return d7Card("JORNADA · DEL LAGO A LA TURBERA",`<div class="day7-route"><div class="route-place local"><b>1</b><strong>ULRICEHAMN</strong><span>ciudad junto al lago</span></div><i>↓</i><div class="route-place lake"><b>2</b><strong>ÅSUNDEN</strong><span>lago de hoy y batalla de 1520</span></div><i>↓</i><div class="route-place local"><b>3</b><strong>SKOTTEK</strong><span>orilla y monumento</span></div><i>↓</i><div class="route-place castle"><b>4</b><strong>TORPA STENHUS</strong><span>casa histórica</span></div><i>↓</i><div class="route-place peat"><b>5</b><strong>KOMOSSE</strong><span>turberas y pasarelas</span></div><i>→</i><div class="route-place next"><b>6</b><strong>STORE MOSSE</strong><span>siguiente paisaje del viaje</span></div></div>`,"No es un mapa para calcular una ruta. Ordena los seis lugares de la jornada y muestra por qué no obedecen la misma regla de paso.")}
  ...
  function d7GotarMap(){return d7Card("TRES GRANDES REGIONES HISTÓRICAS",`<div class="sweden-regions-map" role="img" aria-label="Mapa esquemático de Suecia dividido en Norrland, Svealand y Götaland; Västergötland aparece señalado dentro de Götaland"><div class="sweden-outline"><section class="sweden-north"><b>NORRLAND</b><span>gran región del norte</span></section><section class="sweden-mid"><b>SVEALAND</b><span>región central · Estocolmo</span></section><section class="sweden-south"><b>GÖTALAND</b><span>gran región del sur</span><strong>● Västergötland<br><small>Ulricehamn y Torpa</small></strong></section></div><div class="sweden-sea">MAR BÁLTICO</div></div>`,"Las zonas muestran una organización histórica de Suecia. Västergötland está dentro de Götaland, no es una cuarta región.")}
