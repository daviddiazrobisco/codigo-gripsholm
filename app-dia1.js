(() => {
  ...
  function d7GotarMap(){return d7Card("TRES GRANDES REGIONES HISTÓRICAS",`<div class="regions-card"><div class="region-north"><b>NORRLAND</b><span>gran región del norte</span></div><div class="region-mid"><b>SVEALAND</b><span>región central, donde está Estocolmo</span></div><div class="region-south"><b>GÖTALAND</b><span>gran región del sur</span><strong>VÄSTERGÖTLAND · aquí está Ulricehamn y Torpa</strong></div></div>`,"Las tres regiones son una manera histórica de organizar Suecia. Västergötland es una parte de Götaland, no una cuarta región.")}
