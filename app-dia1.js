(() => {
  ...
  function d6TeaWorldMap(){return d6Card("MAPA MUNDIAL · GOTEMBURGO → CANTÓN",`<div class="d6-world-map"><svg viewBox="0 0 420 260" role="img" aria-label="Mapa mundial con América, Europa, África, Asia y Oceanía. La ruta marítima va de Gotemburgo por el Atlántico, el cabo de Buena Esperanza, el océano Índico y el estrecho de Sonda hasta Cantón."><rect class="d6-ocean" width="420" height="260" rx="18"/><path class="d6-land" d="M18 38l22-13 29 4 14 13-5 19-17 8-4 18-19 2-13-17-14-5zM88 23l23-11 20 5 6 18-15 14-25-3-13-12z"/><path class="d6-land" d="M111 119l21 8 12 22-5 23 11 22-8 30-17 18-11-17 5-23-12-18 5-22-10-14z"/><path class="d6-land" d="M198 43l14-16 19 3 8 14-6 20-14 7-17-9z"/><path class="d6-land" d="M228 48l35-10 43 6 21 10 39-2 30 15 13 18-18 10-3 17-25 8-15-9-20 9-28-5-20-13-20 3-13-13-22-7-12-18z"/><path class="d6-land africa" d="M209 78l27 1 22 14 4 24-13 26-2 29-14 29-17-18-11-28-10-23 8-20z"/><path class="d6-land" d="M344 177l22-5 23 9 3 15-18 11-26-7-10-13zM326 214l12-4 11 6-3 11-16 1-8-7z"/><path class="d6-route" d="M218 58 C207 87 195 116 204 145 C211 165 227 189 233 201 C254 202 276 184 289 161 C302 140 316 128 330 121 C346 112 354 100 366 89"/><text class="d6-continent" x="43" y="84">AMÉRICA DEL NORTE</text><text class="d6-continent" x="94" y="205">AMÉRICA DEL SUR</text><text class="d6-continent" x="212" y="25">EUROPA</text><text class="d6-continent" x="218" y="132">ÁFRICA</text><text class="d6-continent" x="319" y="71">ASIA</text><text class="d6-continent" x="343" y="221">OCEANÍA</text><text class="d6-ocean-label" x="148" y="112">ATLÁNTICO</text><text class="d6-ocean-label" x="282" y="189">ÍNDICO</text>${[["1",218,58,"Gotemburgo",8,-9],["2",233,201,"Cabo de Buena Esperanza",8,17],["3",330,121,"estrecho de Sonda",8,17],["4",366,89,"Cantón",-7,-9]].map(x=>`<circle class="d6-stop" cx="${x[1]}" cy="${x[2]}" r="10"/><text class="d6-stop-number" x="${x[1]}" y="${x[2]+4}" text-anchor="middle">${x[0]}</text><text class="d6-stop-label" x="${x[1]+x[4]}" y="${x[2]+x[5]}" text-anchor="${x[4]<0?"end":"start"}">${x[3]}</text>`).join("")}</svg></div><div class="route-legend"><span><b>1</b> Gotemburgo · salida al Atlántico</span><span><b>2</b> Cabo de Buena Esperanza · giro al Índico</span><span><b>3</b> Estrecho de Sonda · paso al mar de Java</span><span><b>4</b> Cantón · llegada a China</span></div>`,"El mapa muestra continentes completos y los pasos que dan sentido a la ruta. La línea es esquemática: un viaje real dependía de vientos, escalas y navegación.")}
